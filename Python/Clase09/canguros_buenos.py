...
class Canguro():
    ...
    def __str__(self):
        return f'El nombre del canguro es: {self.nombre} y el contenido de su marsupio es: {self.contenido_marsupio}'   
    def __repr__(self):
...
#El error es que cada vez que agrego un nuevo elemento a contenido_marsupio , se replica en los demas objetos. Ya que pisa la misma lista
